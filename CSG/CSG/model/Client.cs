...
namespace CSG.model
{
    class Client
    {
        ...
        public Client(string client_id, string client_name, string client_address, string client_city, 
            string client_department, string client_tel1, string client_email, char client_type)
        {
            Client_id = client_id;
        ...
        public Client(string client_id, string client_name, string client_address, string client_location, 
            ...
            string client_fax, string client_lstructure, char client_type)
        {
            Client_id = client_id;
            Client_name = client_name;
            Client_address = client_address;
