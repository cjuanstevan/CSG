...
namespace CSG.model
{
    class Refaction
    {
        ...
        private string _refaction_unit_price;
        ...
        public Refaction(string refaction_code, string refaction_description, string refaction_unit_price)
        {
            Refaction_code = refaction_code;
            Refaction_description = refaction_description;
            Refaction_unit_price = refaction_unit_price;
        }
        ...
        public string Refaction_unit_price { get => _refaction_unit_price; set => _refaction_unit_price = value; }
